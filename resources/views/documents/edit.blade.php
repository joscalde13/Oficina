    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Editar Documento</h1>
            ...
            <form action="{{ route('documents.update', $document) }}" method="POST" class="bg-white dark:bg-zinc-900 shadow-md rounded-lg px-8 sm:px-12 pt-6 pb-8 mb-4 space-y-6">
                @csrf
                @method('PUT')
