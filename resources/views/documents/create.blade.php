<x-layouts.app :title="__('Nuevo Documento')">
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">Crear Nuevo Documento</h1>

            <form action="{{ route('documents.store') }}" method="POST" class="bg-white dark:bg-zinc-900 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                @csrf
